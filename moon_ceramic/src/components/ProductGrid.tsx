          ...
          <div key={product.id} className="flex flex-col text-left">
            ...
            <button onClick={() =>
             navigate(`/product/${product.id}`)}
              className="mt-6 border border-stone-800 py-2 text-[9px] uppercase tracking-widest font-bold hover:bg-stone-800 hover:text-white transition cursor-pointer">
              Add to Cart
            </button>
          </div>
        ))}
